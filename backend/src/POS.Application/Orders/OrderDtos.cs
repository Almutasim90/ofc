...
public record OrderLineDto(Guid Id,Guid MenuItemId,string Name,decimal UnitPrice,int Quantity,decimal LineTotal,string? Notes,List<Guid> ModifierOptionIds,List<Guid> ComboOptionIds);
