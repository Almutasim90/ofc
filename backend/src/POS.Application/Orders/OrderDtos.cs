...
public record RestaurantOrderDto(Guid Id,Guid BranchId,int OrderNumber,string OrderTypeCode,Guid? TableId,string? TableLabel,string Status,decimal Subtotal,decimal DiscountAmount,decimal GrandTotal,DateTime CreatedAt,List<OrderLineDto> Items,string? CarPlateNumber=null);
