...
public record AddQrOrderRequest(string QrCodeToken, List<CreateOrderLineRequest> Lines);
public record ConfirmQrOrderRequest(Guid SessionId, string QrCodeToken);
