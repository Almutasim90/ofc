using Microsoft.AspNetCore.Authorization;using Microsoft.AspNetCore.Mvc;using Microsoft.AspNetCore.RateLimiting;using POS.Application.Orders;using POS.Application.QrOrdering;
...
public class QrOrderingController(QrOrderingService service):ControllerBase
{
 ...
 [HttpPost("orders/{orderId:guid}/confirm"),AllowAnonymous]public async Task<IActionResult>Confirm(Guid orderId,CancellationToken ct){await service.ConfirmAsync(orderId,ct);return NoContent();}
}
