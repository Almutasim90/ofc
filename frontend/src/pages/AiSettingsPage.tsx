...
export default function AiSettingsPage(){
  ...
  return <section><h1>{t('ai.title')}</h1><p>{t('ai.description')}</p>{message&&<p className="text-primary">{message}</p>}{error&&<p className="error-text" role="alert">{error}</p>}<form className="ui-card ui-stack" onSubmit={submit}>
